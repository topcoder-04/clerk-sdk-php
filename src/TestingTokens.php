...
class TestingTokens
{
     ...
     */
    public function create(?Options $options = null): Operations\CreateTestingTokenResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $hookContext = new HookContext($baseUrl, 'CreateTestingToken', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\TestingToken', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
