...
class Jwks
{
     ...
     */
    public function getJWKS(?Options $options = null): Operations\GetJWKSResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $hookContext = new HookContext($baseUrl, 'GetJWKS', [], $this->sdkConfiguration->securitySource);
