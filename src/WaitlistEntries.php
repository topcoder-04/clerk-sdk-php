...
class WaitlistEntries
{
    ...
    public function create(?Operations\CreateWaitlistEntryRequestBody $request = null, ?Options $options = null): Operations\CreateWaitlistEntryResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries');
        $urlOverride = null;
        ...
        $hookContext = new HookContext($baseUrl, 'CreateWaitlistEntry', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\WaitlistEntry', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CreateWaitlistEntryResponse(
    ...
    public function list(?Operations\ListWaitlistEntriesRequest $request = null, ?Options $options = null): Operations\ListWaitlistEntriesResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\ListWaitlistEntriesRequest::class, $request, $urlOverride);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($baseUrl, 'ListWaitlistEntries', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\WaitlistEntries', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\ListWaitlistEntriesResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    waitlistEntries: $obj);
